...
import AdmBomTypeService from '../../services/adm/bom-type.service';
...
class AdmBomTypeCtl {
  ...
  public create = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
    try {
      ...
      const service = new AdmBomTypeService(req.tenant.uuid);
