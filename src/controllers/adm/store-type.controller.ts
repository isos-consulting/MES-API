...
import AdmStoreService from '../../services/adm/store-type.service';
...
class AdmStoreTypeCtl {
  ...
  public create = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
    try {
      ...
      const service = new AdmStoreService(req.tenant.uuid);
...
export default AdmStoreTypeCtl;