...
import AdmPrdPlanTypeService from '../../services/adm/prd-plan-type.service';
...
class AdmPrdPlanTypeCtl {
  stateTag: string;

  //#region ✅ Constructor
  constructor() {
    this.stateTag = 'admPrdPlanType';
  };
  //#endregion
  ...
  public create = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
    try {
      ...
      const service = new AdmPrdPlanTypeService(req.tenant.uuid);
...
export default AdmPrdPlanTypeCtl;