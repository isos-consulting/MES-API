...
import AdmDemandTypeService from '../../services/adm/demand-type.service';
...
class AdmDemandTypeCtl {
  ...
  public create = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
    try {
      ...
      const service = new AdmDemandTypeService(req.tenant.uuid);
...
export default AdmDemandTypeCtl;