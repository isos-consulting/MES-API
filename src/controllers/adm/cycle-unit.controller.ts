...
import AdmCycleUnitService from '../../services/adm/cycle-unit.service';
...
class AdmCycleUnitCtl {
  ...
  public create = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
    try {
      ...
      const service = new AdmCycleUnitService(req.tenant.uuid);
...
export default AdmCycleUnitCtl;