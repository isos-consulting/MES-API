...
import AdmMenuFileService from '../../services/adm/menu-file.service';
...
class AdmMenuFileCtl {
  stateTag: string;
  
  //#region ✅ Constructor
  constructor() {
    this.stateTag = 'admMenuFile';
  }
  //#endregion
  ...
  public create = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
    try {
      ...
      const service = new AdmMenuFileService(req.tenant.uuid);
