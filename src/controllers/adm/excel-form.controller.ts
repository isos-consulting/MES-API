...
class AdmExcelFormCtl {
  ...
  public readByUuid = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
	...
	// 📒 Fn[readByMenu] (✅ Inheritance): ReadByMenu Function
  public readByMenu = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
    try {
      let result: ApiResult<any> = { count:0, raws: [] };
      const service = new AdmExcelFormService(req.tenant.uuid);

      result = await service.readByMenu();
...
export default AdmExcelFormCtl;