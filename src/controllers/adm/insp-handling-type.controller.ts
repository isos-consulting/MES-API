...
import AdmInspHandlingTypeService from '../../services/adm/insp-handling-type.service';
...
class AdmInspHandlingTypeCtl {
  ...
  public create = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
    try {
      ...
      const service = new AdmInspHandlingTypeService(req.tenant.uuid);
...
export default AdmInspHandlingTypeCtl;