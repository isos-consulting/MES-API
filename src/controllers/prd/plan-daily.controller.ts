...
import PrdPlanDailyService from '../../services/prd/plan-daily.service';

class PrdPlanDailyCtl {
  stateTag: string
  //#region ✅ Constructor
  constructor() {
  ...
  public create = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
    try {
      ...
      const service = new PrdPlanDailyService(req.tenant.uuid);
...
export default PrdPlanDailyCtl;