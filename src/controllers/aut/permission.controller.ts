...
import AutPermissionService from '../../services/aut/permission.service';
...
class AutPermissionCtl {
  stateTag: string

  //#region ✅ Constructor
  constructor() {
    this.stateTag = 'autPermission'
  };
  //#endregion
  ...
  public create = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
    try {
      ...
      const service = new AutPermissionService(req.tenant.uuid);
...
export default AutPermissionCtl;