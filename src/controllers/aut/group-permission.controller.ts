...
import AutGroupPermissionService from '../../services/aut/group-permission.service';
...
class AutGroupPermissionCtl {
  ...
  public create = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
    try {
      ...
      const service = new AutGroupPermissionService(req.tenant.uuid);
  ...
  public update = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
    try {
      ...
      await sequelizes[req.tenant.uuid].transaction(async(tran: any) => { 
				const createResult = await service.create(createBody, req.user?.uid as number, tran);
				const updateResult = await service.create(updateBody, req.user?.uid as number, tran);
