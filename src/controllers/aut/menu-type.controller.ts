...
import AutMenuTypeService from '../../services/aut/menu-type.service';
...
class AutMenuTypeCtl {
  stateTag: string

  //#region ✅ Constructor
  constructor() {
    this.stateTag = 'autMenuType'
  };
  //#endregion
  ...
  public create = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
    try {
      ...
      const service = new AutMenuTypeService(req.tenant.uuid);
