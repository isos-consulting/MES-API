...
import AutUserPermissionService from '../../services/aut/user-permission.service';
...
class AutUserPermissionCtl {
  ...
  public create = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
    try {
      ...
      const service = new AutUserPermissionService(req.tenant.uuid);
