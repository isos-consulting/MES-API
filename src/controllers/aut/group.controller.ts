...
import AutGroupService from '../../services/aut/group.service';
...
class AutGroupCtl {
  ...
  public create = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
    try {
      ...
      const service = new AutGroupService(req.tenant.uuid);
