...
import StdDataItemService from '../../services/gat/data-item.service';
...
class StdDataItemCtl {
  ...
  public create = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
    try {
      ...
      const service = new StdDataItemService(req.tenant.uuid);
