...
import StdDataGearService from '../../services/gat/data-gear.service';
...
class StdDataGearCtl {
  stateTag: string

  //#region ✅ Constructor
  constructor() {
    this.stateTag = 'stdDataGear'
  };
  //#endregion
  ...
  public create = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
    try {
      ...
      const service = new StdDataGearService(req.tenant.uuid);
