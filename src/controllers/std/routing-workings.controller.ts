...
import StdRoutingWorkingsService from '../../services/std/routing-workings.service';
...
class StdRoutingWorkingsCtl {
  ...
  public create = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
    try {
      ...
      const service = new StdRoutingWorkingsService(req.tenant.uuid);
...
export default StdRoutingWorkingsCtl;