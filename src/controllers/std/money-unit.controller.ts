...
import StdMoneyUnitService from '../../services/std/money-unit.service';
...
class StdMoneyUnitCtl {
  stateTag: string

  //#region ✅ Constructor
  constructor() {
    this.stateTag = 'stdMoneyUnitCtl'
  };
  //#endregion
  ...
  public create = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
    try {
      ...
      const service = new StdMoneyUnitService(req.tenant.uuid);
...
export default StdMoneyUnitCtl;