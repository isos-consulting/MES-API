...
import StdProdTypeService from '../../services/std/prod-type.service';
...
class StdProdTypeCtl {
  stateTag: string

  //#region ✅ Constructor
  constructor() {
    this.stateTag = 'stdProdType'
  };
  //#endregion
  ...
  public create = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
    try {
      ...
      const service = new StdProdTypeService(req.tenant.uuid);
