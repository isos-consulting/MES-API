...
import StdItemTypeService from '../../services/std/item-type.service';
...
class StdItemTypeCtl {
  stateTag: string

  //#region ✅ Constructor
  constructor() {
    this.stateTag = 'stdItemType'
  };
  //#endregion
  ...
  public create = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
    try {
      ...
      const service = new StdItemTypeService(req.tenant.uuid);
