...
import StdWorkerGroupService from '../../services/std/worker-group.service';
...
class StdWorkerGroupCtl {
  stateTag: string

  //#region ✅ Constructor
  constructor() {
    this.stateTag = 'stdWorkerGroup'
  };
  //#endregion
  ...
  public create = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
    try {
      ...
      const service = new StdWorkerGroupService(req.tenant.uuid);
...
export default StdWorkerGroupCtl;