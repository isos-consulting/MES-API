...
import StdBarcodeHistoryService from '../../services/std/barcode-history.service';
...
class StdBarcodeHistoryCtl {
  stateTag: string;

  //#region ✅ Constructor
  constructor () {
    this.stateTag = 'stdBarcodeHistory';
  }
  //#endregion
  ...
  public create = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
    try {
      ...
      const service = new StdBarcodeHistoryService(req.tenant.uuid);
...
export default StdBarcodeHistoryCtl;