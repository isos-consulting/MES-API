...
import StdBarcodeService from '../../services/std/barcode.service';
...
class StdBarcodeCtl {
  ...
  public create = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
    try {
      ...
      const service = new StdBarcodeService(req.tenant.uuid);
