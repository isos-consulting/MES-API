...
import StdDeliveryService from '../../services/std/delivery.service';
...
class StdDeliveryCtl {
  ...
  public create = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
    try {
      ...
      const service = new StdDeliveryService(req.tenant.uuid);
