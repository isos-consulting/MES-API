...
import StdInspMethodService from '../../services/std/insp-method.service';
...
class StdInspMethodCtl {
  stateTag: string

  //#region ✅ Constructor
  constructor() {
    this.stateTag = 'stdInspMethod'
  };
  //#endregion
  ...
  public create = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
    try {
      ...
      const service = new StdInspMethodService(req.tenant.uuid);
...
export default StdInspMethodCtl;