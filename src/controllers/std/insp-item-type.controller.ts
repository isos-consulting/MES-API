...
import StdInspItemTypeService from '../../services/std/insp-item-type.service';
...
class StdInspItemTypeCtl {
  ...
  public create = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
    try {
      ...
      const service = new StdInspItemTypeService(req.tenant.uuid);
...
export default StdInspItemTypeCtl;