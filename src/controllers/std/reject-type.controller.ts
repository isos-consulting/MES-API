...
import StdRejectTypeService from '../../services/std/reject-type.service';
...
class StdRejectTypeCtl {
  ...
  public create = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
    try {
      ...
      const service = new StdRejectTypeService(req.tenant.uuid);
...
export default StdRejectTypeCtl;