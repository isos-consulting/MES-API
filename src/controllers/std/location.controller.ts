...
import StdLocationService from '../../services/std/location.service';
...
class StdLocationCtl {
  stateTag: string

  //#region ✅ Constructor
  constructor() {
    this.stateTag = 'stdLocation'
  };
  //#endregion
  ...
  public create = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
    try {
      ...
      const service = new StdLocationService(req.tenant.uuid);
