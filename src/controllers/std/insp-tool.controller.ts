...
import StdInspToolService from '../../services/std/insp-tool.service';
...
class StdInspToolCtl {
  stateTag: string

  //#region ✅ Constructor
  constructor() {
    this.stateTag = 'stdInspTool'
  };
  //#endregion
  ...
  public create = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
    try {
      ...
      const service = new StdInspToolService(req.tenant.uuid);
