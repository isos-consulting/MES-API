...
import StdDowntimeTypeService from '../../services/std/downtime-type.service';
...
class StdDowntimeTypeCtl {
  ...
  public create = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
    try {
      ...
      const service = new StdDowntimeTypeService(req.tenant.uuid);
...
export default StdDowntimeTypeCtl;