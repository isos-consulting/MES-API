...
import StdWorktimeTypeService from '../../services/std/worktime-type.service';

class StdWorktimeTypeCtl {
  stateTag: string
  ...
  public create = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
    try {
      ...
      const service = new StdWorktimeTypeService(req.tenant.uuid);
...
export default StdWorktimeTypeCtl;