...
import StdPriceTypeService from '../../services/std/price-type.service';
...
class StdPriceTypeCtl {
  stateTag: string

  //#region ✅ Constructor
  constructor() {
    this.stateTag = 'stdPriceType'
  };
  //#endregion
  ...
  public create = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
    try {
      ...
      const service = new StdPriceTypeService(req.tenant.uuid);
...
export default StdPriceTypeCtl;