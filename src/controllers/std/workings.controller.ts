...
import StdWorkingsService from '../../services/std/workings.service';
...
class StdWorkingsCtl {
  stateTag: string

  //#region ✅ Constructor
  constructor() {
    this.stateTag = 'stdWorkings'
  };
  //#endregion
  ...
  public create = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
    try {
      ...
      const service = new StdWorkingsService(req.tenant.uuid);
