...
import StdPartnerTypeService from '../../services/std/partner-type.service';
...
class StdPartnerTypeCtl {
  ...
  public create = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
    try {
      ...
      const service = new StdPartnerTypeService(req.tenant.uuid);
...
export default StdPartnerTypeCtl;