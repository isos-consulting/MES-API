import StdCompanyRepo from '../../repositories/std/company.repository';
import BaseCtl from '../base.controller';

class StdCompanyCtl extends BaseCtl {
  ...
  constructor() {
    ...
    super(new StdCompanyRepo());

    // ✅ CUD 연산이 실행되기 전 Fk Table 의 uuid 로 id 를 검색하여 request body 에 삽입하기 위하여 정보 Setting
    // this.fkIdInfos = [
    //   {
    //     key: 'companyType',
    //     repo: new StdCompanyTypeRepo(),
    //     idName: 'company_type_id',
    //     uuidName: 'company_type_uuid'
    //   },
    // ];
  };
  //#endregion
