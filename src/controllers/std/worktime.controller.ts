...
import StdWorktimeService from '../../services/std/worktime.service';

class StdWorktimeCtl {
  stateTag: string
  ...
  public create = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
    try {
      ...
      const service = new StdWorktimeService(req.tenant.uuid);
  ...
  public workHours = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
    try {
      let result: ApiResult<any> = { count:0, raws: [] };
      const service = new StdWorktimeService(req.tenant.uuid);
      const params = matchedData(req, { locations: [ 'query', 'params' ] });

      result = await service.workHours(params);
