...
import StdWorkTypeService from '../../services/std/work-type.service';

class StdWorkTypeCtl {
  stateTag: string
  ...
  public create = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
    try {
      ...
      const service = new StdWorkTypeService(req.tenant.uuid);
