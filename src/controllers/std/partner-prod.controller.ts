...
import StdPartnerProdService from '../../services/std/partner-prod.service';
...
class StdPartnerProdCtl {
  ...
  public create = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
    try {
      ...
      const service = new StdPartnerProdService(req.tenant.uuid);
...
export default StdPartnerProdCtl;