...
import StdSupplierService from '../../services/std/supplier.service';
...
class StdSupplierCtl {
  ...
  public create = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
    try {
      ...
      const service = new StdSupplierService(req.tenant.uuid);
