...
import StdEquipTypeService from '../../services/std/equip-type.service';
...
class StdEquipTypeCtl {
  stateTag: string

  //#region ✅ Constructor
  constructor() {
    this.stateTag = 'stdEquipType'
  };
  //#endregion
  ...
  public create = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
    try {
      ...
      const service = new StdEquipTypeService(req.tenant.uuid);
...
export default StdEquipTypeCtl;