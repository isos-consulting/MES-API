...
import StdGradeService from '../../services/std/grade.service';
...
class StdGradeCtl {
  ...
  public create = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
    try {
      ...
      const service = new StdGradeService(req.tenant.uuid);
