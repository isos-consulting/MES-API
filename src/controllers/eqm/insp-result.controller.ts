...
import EqmInspResultService from '../../services/eqm/insp-result.service';
...
class EqmInspResultCtl {
  ...
  public create = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
    try {
      ...
      const service = new EqmInspResultService(req.tenant.uuid);
...
export default EqmInspResultCtl;