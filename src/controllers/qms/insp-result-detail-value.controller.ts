...
import QmsIsnpResultDetailValueService from '../../services/qms/insp-result-detail-value.service';
...
class QmsInspResultDetailValueCtl {
  stateTag: string;
  constructor() {
  ...
  public create = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
    try {
      ...
      const service = new QmsIsnpResultDetailValueService(req.tenant.uuid);
...
export default QmsInspResultDetailValueCtl;