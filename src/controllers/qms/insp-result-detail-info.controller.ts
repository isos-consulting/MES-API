...
import QmsIsnpResultDetailInfoService from '../../services/qms/insp-result-detail-info.service';
...
class QmsInspResultDetailInfoCtl {
  stateTag: string;
  constructor() {
  ...
  public create = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
    try {
      ...
      const service = new QmsIsnpResultDetailInfoService(req.tenant.uuid);
...
export default QmsInspResultDetailInfoCtl;