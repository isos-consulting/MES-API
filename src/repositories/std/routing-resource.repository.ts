...
class StdRoutingResourceRepo {
  ...
  //#region ✅ Constructor
  constructor() {
    this.repo = sequelize.getRepository(StdRoutingResource);
  }
  //#endregion
    ...
    try {
      const result = await this.repo.findAll({ 
        include: [
          ...
          { 
            model: sequelize.models.StdRouting, 
            attributes: [], 
    ...
    try {
      const result = await this.repo.findOne({ 
        include: [
          ...
          { model: sequelize.models.StdRouting, attributes: [], required: false },
          { model: sequelize.models.StdEquip, attributes: [], required: false },
          { model: sequelize.models.AutUser, as: 'createUser', attributes: [], required: true },
          { model: sequelize.models.AutUser, as: 'updateUser', attributes: [], required: true },
        ],
  ...
  public update = async(body: IStdRoutingResource[], uid: number, transaction?: Transaction) => {
    ...
    try {
      ...
      await new AdmLogRepo().create('update', sequelize.models.StdRoutingResource.getTableName() as string, previousRaws, uid, transaction);
  ...
  public delete = async(body: IStdRoutingResource[], uid: number, transaction?: Transaction) => {
    ...
    try {      
      ...
      await new AdmLogRepo().create('delete', sequelize.models.StdRoutingResource.getTableName() as string, previousRaws, uid, transaction);
