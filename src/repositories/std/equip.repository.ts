    ...
    try {
      const result = await this.repo.findAll({ 
        ...
        attributes: [
          ...
          [ Sequelize.col('managerEmp.manager_emp_cd'), 'manager_emp_cd' ],
          [ Sequelize.col('managerEmp.manager_emp_nm'), 'manager_emp_nm' ],
          [ Sequelize.col('subManagerEmp.uuid'), 'sub_manager_emp_uuid' ],
          [ Sequelize.col('subManagerEmp.sub_manager_emp_cd'), 'sub_manager_emp_cd' ],
          [ Sequelize.col('subManagerEmp.sub_manager_emp_nm'), 'sub_manager_emp_nm' ],
					'equip_no',
					'equip_grade',
					'equip_model',
					'equip_std',
