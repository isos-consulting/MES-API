...
class StdPriceTypeRepo {
  ...
  //#region ✅ Constructor
  constructor() {
    this.repo = sequelize.getRepository(StdPriceType);
  }
  //#endregion
  ...
  public readRawByUnique = async(params: { price_type_cd: string }) => {
    const result = await this.repo.findOne({ where: { price_type_cd: params.price_type_cd } });
    return convertReadResult(result);
  };
  ...
  public update = async(body: IStdPriceType[], uid: number, transaction?: Transaction) => {
    ...
    try {
      ...
      await new AdmLogRepo().create('update', sequelize.models.StdPriceType.getTableName() as string, previousRaws, uid, transaction);
  ...
  public delete = async(body: IStdPriceType[], uid: number, transaction?: Transaction) => {
    ...
    try {      
      ...
      await new AdmLogRepo().create('delete', sequelize.models.StdPriceType.getTableName() as string, previousRaws, uid, transaction);
...
export default StdPriceTypeRepo;