...
class StdWorkerRepo {
  ...
  //#region ✅ Constructor
  constructor() {
    this.repo = sequelize.getRepository(StdWorker);
  }
  //#endregion
    ...
    try {
      const result = await this.repo.findAll({ 
        include: [
          ...
          { model: sequelize.models.StdEmp, attributes: [], required: false },
  ...
  public update = async(body: IStdWorker[], uid: number, transaction?: Transaction) => {
    ...
    try {
      ...
      await new AdmLogRepo().create('update', sequelize.models.StdWorker.getTableName() as string, previousRaws, uid, transaction);
  ...
  public delete = async(body: IStdWorker[], uid: number, transaction?: Transaction) => {
    ...
    try {      
      ...
      await new AdmLogRepo().create('delete', sequelize.models.StdWorker.getTableName() as string, previousRaws, uid, transaction);
