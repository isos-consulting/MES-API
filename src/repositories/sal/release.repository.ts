...
class SalReleaseRepo {
  repo: Repository<SalRelease>;

  //#region ✅ Constructor
  constructor() {
    this.repo = sequelize.getRepository(SalRelease);
  }
  //#endregion
  ...
  public read = async(params?: any) => {
    try {
      const result = await this.repo.findAll({ 
        ...
        attributes: [
          [ Sequelize.col('salRelease.uuid'), 'release_uuid' ],
        ...
        where: { 
          [Op.and]: [
            Sequelize.where(Sequelize.fn('date', Sequelize.col('salRelease.reg_date')), '>=', params.start_date),
            Sequelize.where(Sequelize.fn('date', Sequelize.col('salRelease.reg_date')), '<=', params.end_date),
          ],
        },
  ...
  public update = async(body: ISalRelease[], uid: number, transaction?: Transaction) => {
    ...
    try {
      ...
      await new AdmLogRepo().create('update', sequelize.models.SalRelease.getTableName() as string, previousRaws, uid, transaction);
  ...
  public delete = async(body: ISalRelease[], uid: number, transaction?: Transaction) => {
    ...
    try {      
      ...
      await new AdmLogRepo().create('delete', sequelize.models.SalRelease.getTableName() as string, previousRaws, uid, transaction);
