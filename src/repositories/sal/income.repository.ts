...
class SalIncomeRepo {
  ...
  //#region ✅ Constructor
  constructor() {
    this.repo = sequelize.getRepository(SalIncome);
  }
  //#endregion
        ...
        include: [
          ...
          { 
            ...
            include: [
              ...
              { model: sequelize.models.StdProdType, attributes: [], required: false },
              { model: sequelize.models.StdModel, attributes: [], required: false },
              { model: sequelize.models.StdUnit, attributes: [], required: false },
            ],
          },
  ...
  public readReport = async(params?: any) => {
    try {
      const result = await sequelize.query(readIncomeReport(params));
  ...
  public update = async(body: ISalIncome[], uid: number, transaction?: Transaction) => {
    ...
    try {
      ...
      await new AdmLogRepo().create('update', sequelize.models.SalIncome.getTableName() as string, previousRaws, uid, transaction);
  ...
  public delete = async(body: ISalIncome[], uid: number, transaction?: Transaction) => {
    ...
    try {      
      ...
      await new AdmLogRepo().create('delete', sequelize.models.SalIncome.getTableName() as string, previousRaws, uid, transaction);
