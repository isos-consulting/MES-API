...
import PrdWorkRoutingOrigin from '../../models/prd/work-routing-origin.model';
import IPrdWorkRoutingOrigin from '../../interfaces/prd/work-routing-origin.interface';

class PrdWorkRoutingOriginRepo {
  repo: Repository<PrdWorkRoutingOrigin>;
  sequelize: Sequelize;
  tenant: string;
  ...
  constructor(tenant: string) {
    ...
    this.repo = this.sequelize.getRepository(PrdWorkRoutingOrigin);
  }
  //#endregion
  ...
  public create = async(body: IPrdWorkRoutingOrigin[], uid: number, transaction?: Transaction) => {
    try {
  ...
  public update = async(body: IPrdWorkRoutingOrigin[], uid: number, transaction?: Transaction) => {
    try {
      ...
      await new AdmLogRepo(this.tenant).create('update', this.sequelize.models.PrdWorkRoutingOrigin.getTableName() as string, previousRaws, uid, transaction);
  ...
  public patch = async(body: IPrdWorkRoutingOrigin[], uid: number, transaction?: Transaction) => {
    try {
      const previousRaws = await getPreviousRaws(body, this.repo);
  ...
  public delete = async(body: IPrdWorkRoutingOrigin[], uid: number, transaction?: Transaction) => {
    try {      
      const previousRaws = await getPreviousRaws(body, this.repo);
      ...
      await new AdmLogRepo(this.tenant).create('delete', this.sequelize.models.PrdWorkRoutingOrigin.getTableName() as string, previousRaws, uid, transaction);
...
export default PrdWorkRoutingOriginRepo;