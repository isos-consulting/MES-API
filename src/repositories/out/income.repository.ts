...
class OutIncomeRepo {
  ...
  //#region ✅ Constructor
  constructor() {
    this.repo = sequelize.getRepository(OutIncome);
  }
  //#endregion
  ...
  public update = async(body: IOutIncome[], uid: number, transaction?: Transaction) => {
    ...
    try {
      ...
      await new AdmLogRepo().create('update', sequelize.models.OutIncome.getTableName() as string, previousRaws, uid, transaction);
  ...
  public delete = async(body: IOutIncome[], uid: number, transaction?: Transaction) => {
    ...
    try {      
      ...
      await new AdmLogRepo().create('delete', sequelize.models.OutIncome.getTableName() as string, previousRaws, uid, transaction);
