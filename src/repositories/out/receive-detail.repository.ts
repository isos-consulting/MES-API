...
class OutReceiveDetailRepo {
  ...
  public create = async(body: IOutReceiveDetail[], uid: number, transaction?: Transaction) => {
    try {
  ...
  public update = async(body: IOutReceiveDetail[], uid: number, transaction?: Transaction) => {
    try {
  ...
  public patch = async(body: IOutReceiveDetail[], uid: number, transaction?: Transaction) => {
    try {
      const previousRaws = await getPreviousRaws(body, this.repo);
  ...
  public delete = async(body: IOutReceiveDetail[], uid: number, transaction?: Transaction) => {
    try {      
      const previousRaws = await getPreviousRaws(body, this.repo);
...
export default OutReceiveDetailRepo;