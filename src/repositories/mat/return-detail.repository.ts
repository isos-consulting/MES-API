    ...
    try {
      ...
      const result = await this.repo.findAll({ 
        ...
        attributes: [
          ...
          'qty',
          [ Sequelize.literal('matReturnDetail.qty * matReturnDetail.convert_value'), 'return_qty' ],
          [ Sequelize.col('stdUnit.uuid'), 'return_unit_uuid' ],
          [ Sequelize.col('stdUnit.unit_cd'), 'return_unit_cd' ],
          [ Sequelize.col('stdUnit.unit_nm'), 'return_unit_nm' ],
          'convert_value',
          'price',
