...
class SalOutgoOrderService {
  ...
  constructor(tenant: string) {
    ...
    this.repo = new SalOutgoOrderRepo(tenant);
   ...
   */
    ...
    const totalQty = await this.detailRepo.getTotalQty(id, tran);
...
export default SalOutgoOrderService;