...
const seedDatas: IAutMenu[] = [
	...
	{ menu_id: 1, menu_type_id: null, menu_nm: '기준정보', menu_uri: 'std', menu_form_nm: null, component_nm: null, icon: 'ico_nav_standard', parent_id: 0, sortby: 1, use_fg: true, created_uid: 1, updated_uid: 1 },
		{ menu_id: 2, menu_type_id: 2, menu_nm: '공장 등록', menu_uri: '\/std\/factories', menu_form_nm: 'frm_STD_Factory', component_nm: 'PgStdFactory', icon: null, parent_id: 1, sortby: 1, use_fg: true, created_uid: 1, updated_uid: 1 },
		{ menu_id: 3, menu_type_id: null, menu_nm: '거래처 정보', menu_uri: '\/std\/partner', menu_form_nm: null, component_nm: null, icon: null, parent_id: 1, sortby: 2, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 4, menu_type_id: 2, menu_nm: '거래처유형 등록', menu_uri: '\/std\/partner-types', menu_form_nm: 'frm_STD_PartnerType', component_nm: 'PgStdPartnerType', icon: null, parent_id: 3, sortby: 1, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 5, menu_type_id: 2, menu_nm: '거래처 등록', menu_uri: '\/std\/partners', menu_form_nm: 'frm_STD_Partner', component_nm: 'PgStdPartner', icon: null, parent_id: 3, sortby: 2, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 6, menu_type_id: 2, menu_nm: '거래처 품번 등록', menu_uri: '\/std\/partner-prods', menu_form_nm: 'frm_STD_PartnerProd', component_nm: 'PgStdPartnerProd', icon: null, parent_id: 3, sortby: 3, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 7, menu_type_id: 2, menu_nm: '공급처 등록', menu_uri: '\/std\/suppliers', menu_form_nm: 'frm_STD_Supplier', component_nm: 'PgStdSupplier', icon: null, parent_id: 3, sortby: 4, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 8, menu_type_id: 2, menu_nm: '납품처 등록', menu_uri: '\/std\/deliveries', menu_form_nm: 'frm_STD_Delivery', component_nm: 'PgStdDelivery', icon: null, parent_id: 3, sortby: 5, use_fg: true, created_uid: 1, updated_uid: 1 },
		{ menu_id: 9, menu_type_id: null, menu_nm: '단가 정보', menu_uri: '\/std\/price', menu_form_nm: null, component_nm: null, icon: null, parent_id: 1, sortby: 3, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 10, menu_type_id: 2, menu_nm: '화폐단위 등록', menu_uri: '\/std\/money-units', menu_form_nm: 'frm_STD_MoneyUnit', component_nm: 'PgStdMoneyUnit', icon: null, parent_id: 9, sortby: 1, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 11, menu_type_id: 2, menu_nm: '단가유형 등록', menu_uri: '\/std\/price-types', menu_form_nm: 'frm_STD_PriceType', component_nm: 'PgStdPriceType', icon: null, parent_id: 9, sortby: 2, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 12, menu_type_id: 2, menu_nm: '구매단가 등록', menu_uri: '\/std\/vendor-prices', menu_form_nm: 'frm_STD_VendorPrice', component_nm: 'PgStdVendorPrice', icon: null, parent_id: 9, sortby: 3, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 13, menu_type_id: 2, menu_nm: '판매단가 등록', menu_uri: '\/std\/customer-prices', menu_form_nm: 'frm_STD_CustomerPrice', component_nm: 'PgStdCustomerPrice', icon: null, parent_id: 9, sortby: 4, use_fg: true, created_uid: 1, updated_uid: 1 },
		{ menu_id: 14, menu_type_id: null, menu_nm: '사원 정보', menu_uri: '\/std\/emp', menu_form_nm: null, component_nm: null, icon: null, parent_id: 1, sortby: 4, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 15, menu_type_id: 2, menu_nm: '부서 등록', menu_uri: '\/std\/depts', menu_form_nm: 'frm_STD_Dept', component_nm: 'PgStdDept', icon: null, parent_id: 14, sortby: 1, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 16, menu_type_id: 2, menu_nm: '직급 등록', menu_uri: '\/std\/grades', menu_form_nm: 'frm_STD_Grade', component_nm: 'PgStdGrade', icon: null, parent_id: 14, sortby: 2, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 17, menu_type_id: 2, menu_nm: '사원 등록', menu_uri: '\/std\/emps', menu_form_nm: 'frm_STD_Employee', component_nm: 'PgStdEmployee', icon: null, parent_id: 14, sortby: 3, use_fg: true, created_uid: 1, updated_uid: 1 },
		{ menu_id: 18, menu_type_id: 2, menu_nm: '공정 등록', menu_uri: '\/std\/procs', menu_form_nm: 'frm_STD_Process', component_nm: 'PgStdProcess', icon: null, parent_id: 1, sortby: 5, use_fg: true, created_uid: 1, updated_uid: 1 },
		{ menu_id: 19, menu_type_id: 2, menu_nm: '작업장 등록', menu_uri: '\/std\/workings', menu_form_nm: 'frm_STD_Workings', component_nm: 'PgStdWorkings', icon: null, parent_id: 1, sortby: 6, use_fg: true, created_uid: 1, updated_uid: 1 },
		{ menu_id: 20, menu_type_id: null, menu_nm: '설비 정보', menu_uri: '\/std\/equip', menu_form_nm: null, component_nm: null, icon: null, parent_id: 1, sortby: 7, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 21, menu_type_id: 2, menu_nm: '설비 유형 등록', menu_uri: '\/std\/equip-types', menu_form_nm: 'frm_STD_EquipmentType', component_nm: 'PgStdEquipmentType', icon: null, parent_id: 20, sortby: 1, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 22, menu_type_id: 2, menu_nm: '설비 등록', menu_uri: '\/std\/equips', menu_form_nm: 'frm_STD_Equipment', component_nm: 'PgStdEquipment', icon: null, parent_id: 20, sortby: 2, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 23, menu_type_id: 2, menu_nm: '공정별 설비 등록', menu_uri: '\/std\/proc-equips', menu_form_nm: null, component_nm: 'PgStdProcEquip', icon: null, parent_id: 20, sortby: 3, use_fg: true, created_uid: 1, updated_uid: 1 },
		{ menu_id: 24, menu_type_id: 2, menu_nm: '창고 등록', menu_uri: '\/std\/stores', menu_form_nm: 'frm_STD_Store', component_nm: 'PgStdStore', icon: null, parent_id: 1, sortby: 8, use_fg: true, created_uid: 1, updated_uid: 1 },
		{ menu_id: 25, menu_type_id: 2, menu_nm: '위치 등록', menu_uri: '\/std\/locations', menu_form_nm: 'frm_STD_Location', component_nm: 'PgStdLocation', icon: null, parent_id: 1, sortby: 9, use_fg: true, created_uid: 1, updated_uid: 1 },
		{ menu_id: 26, menu_type_id: null, menu_nm: '비가동 정보', menu_uri: '\/std\/downtime', menu_form_nm: null, component_nm: null, icon: null, parent_id: 1, sortby: 10, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 27, menu_type_id: 2, menu_nm: '비가동 유형 등록', menu_uri: '\/std\/downtime-types', menu_form_nm: 'frm_STD_DowntimeType', component_nm: 'PgStdDowntimeType', icon: null, parent_id: 26, sortby: 1, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 28, menu_type_id: 2, menu_nm: '비가동 등록', menu_uri: '\/std\/downtimes', menu_form_nm: 'frm_STD_Downtime', component_nm: 'PgStdDowntime', icon: null, parent_id: 26, sortby: 2, use_fg: true, created_uid: 1, updated_uid: 1 },
		{ menu_id: 29, menu_type_id: null, menu_nm: '불량 정보', menu_uri: '\/std\/reject', menu_form_nm: null, component_nm: null, icon: null, parent_id: 1, sortby: 11, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 30, menu_type_id: 2, menu_nm: '불량유형 등록', menu_uri: '\/std\/reject-types', menu_form_nm: 'frm_STD_RejectType', component_nm: 'PgStdRejectType', icon: null, parent_id: 29, sortby: 1, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 31, menu_type_id: 2, menu_nm: '불량 등록', menu_uri: '\/std\/rejects', menu_form_nm: 'frm_STD_Reject', component_nm: 'PgStdReject', icon: null, parent_id: 29, sortby: 2, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 32, menu_type_id: 2, menu_nm: '공정별 불량 등록', menu_uri: '\/std\/proc-reject', menu_form_nm: 'frm_STD_ProcReject', component_nm: 'PgStdProcReject', icon: null, parent_id: 29, sortby: 3, use_fg: true, created_uid: 1, updated_uid: 1 },
		{ menu_id: 33, menu_type_id: null, menu_nm: '검사기준 정보', menu_uri: '\/std\/insp', menu_form_nm: null, component_nm: null, icon: null, parent_id: 1, sortby: 12, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 34, menu_type_id: 2, menu_nm: '검사기준 유형 등록', menu_uri: '\/std\/insp-item-types', menu_form_nm: 'frm_STD_InspItemType', component_nm: 'PgStdInspItemType', icon: null, parent_id: 33, sortby: 1, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 35, menu_type_id: 2, menu_nm: '검사기준 등록', menu_uri: '\/std\/insp-items', menu_form_nm: 'frm_STD_InspItme', component_nm: 'PgStdInspItem', icon: null, parent_id: 33, sortby: 2, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 36, menu_type_id: 2, menu_nm: '검사구 등록', menu_uri: '\/std\/insp-tools', menu_form_nm: 'frm_STD_InspTool', component_nm: 'PgStdInspTool', icon: null, parent_id: 33, sortby: 3, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 37, menu_type_id: 2, menu_nm: '검사방법 등록', menu_uri: '\/std\/insp-methods', menu_form_nm: 'frm_STD_InspMethod', component_nm: 'PgStdInspMethod', icon: null, parent_id: 33, sortby: 4, use_fg: true, created_uid: 1, updated_uid: 1 },
		...
		{ menu_id: 43, menu_type_id: null, menu_nm: '단위 정보', menu_uri: '\/std\/unit', menu_form_nm: null, component_nm: null, icon: null, parent_id: 1, sortby: 14, use_fg: true, created_uid: 1, updated_uid: 1 },
			...
			{ menu_id: 45, menu_type_id: 2, menu_nm: '단위 변환값 등록', menu_uri: '\/std\/unit-converts', menu_form_nm: 'frm_STD_UnitConvert', component_nm: 'PgStdUnitConvert', icon: null, parent_id: 43, sortby: 2, use_fg: true, created_uid: 1, updated_uid: 1 },
		{ menu_id: 46, menu_type_id: null, menu_nm: '권한 정보', menu_uri: '\/std\/aut', menu_form_nm: null, component_nm: null, icon: null, parent_id: 1, sortby: 15, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 47, menu_type_id: 2, menu_nm: '권한기준 등록', menu_uri: '\/std\/aut\/permissions', menu_form_nm: 'frm_AUT_Permission', component_nm: 'PgAutPermission', icon: null, parent_id: 46, sortby: 1, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 48, menu_type_id: 2, menu_nm: '권한그룹 등록', menu_uri: '\/std\/aut\/groups', menu_form_nm: 'frm_AUT_Group', component_nm: 'PgAutGroup', icon: null, parent_id: 46, sortby: 2, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 49, menu_type_id: 2, menu_nm: '그룹별 권한 등록', menu_uri: '\/std\/aut\/group-permissions', menu_form_nm: 'frm_AUT_GroupPermission', component_nm: 'PgAutGroupPermission', icon: null, parent_id: 46, sortby: 3, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 50, menu_type_id: 2, menu_nm: '사용자 등록', menu_uri: '\/std\/aut\/users', menu_form_nm: 'frm_AUT_User', component_nm: 'PgAutUser', icon: null, parent_id: 46, sortby: 4, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 51, menu_type_id: 2, menu_nm: '사용자권한 등록', menu_uri: '\/std\/aut\/user-permissions', menu_form_nm: 'frm_AUT_UserPermission', component_nm: 'PgAutUserPermission', icon: null, parent_id: 46, sortby: 5, use_fg: true, created_uid: 1, updated_uid: 1 },
	...
	{ menu_id: 52, menu_type_id: null, menu_nm: '사양관리', menu_uri: 'spec', menu_form_nm: null, component_nm: null, icon: 'ico_nav_standard', parent_id: 0, sortby: 2, use_fg: true, created_uid: 1, updated_uid: 1 },
		{ menu_id: 53, menu_type_id: null, menu_nm: '품목 정보', menu_uri: '\/spec\/item', menu_form_nm: null, component_nm: null, icon: null, parent_id: 52, sortby: 1, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 54, menu_type_id: 2, menu_nm: '품목유형 등록', menu_uri: '\/spec\/item-types', menu_form_nm: 'frm_STD_ItemType', component_nm: 'PgStdItemType', icon: null, parent_id: 53, sortby: 1, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 55, menu_type_id: 2, menu_nm: '모델 등록', menu_uri: '\/spec\/models', menu_form_nm: 'frm_STD_Model', component_nm: 'PgStdModel', icon: null, parent_id: 53, sortby: 2, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 56, menu_type_id: 2, menu_nm: '제품유형 등록', menu_uri: '\/spec\/prod-types', menu_form_nm: 'frm_STD_ProdTYpe', component_nm: 'PgStdProdType', icon: null, parent_id: 53, sortby: 3, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 57, menu_type_id: 2, menu_nm: '품목 등록', menu_uri: '\/spec\/prods', menu_form_nm: 'frm_STD_Prod', component_nm: 'PgStdProd', icon: null, parent_id: 53, sortby: 4, use_fg: true, created_uid: 1, updated_uid: 1 },
		{ menu_id: 58, menu_type_id: 2, menu_nm: '라우팅 등록', menu_uri: '\/spec\/routings', menu_form_nm: 'frm_STD_Routing', component_nm: 'PgStdRouting', icon: null, parent_id: 52, sortby: 2, use_fg: true, created_uid: 1, updated_uid: 1 },
		{ menu_id: 59, menu_type_id: 2, menu_nm: 'BOM 등록', menu_uri: '\/spec\/boms', menu_form_nm: 'frm_STD_BOM', component_nm: 'PgStdBom', icon: null, parent_id: 52, sortby: 3, use_fg: true, created_uid: 1, updated_uid: 1 },
	...
	{ menu_id: 60, menu_type_id: null, menu_nm: '구매\/자재관리', menu_uri: 'mat', menu_form_nm: null, component_nm: null, icon: 'ico_nav_material', parent_id: 0, sortby: 3, use_fg: true, created_uid: 1, updated_uid: 1 },
		{ menu_id: 61, menu_type_id: null, menu_nm: '발주 정보', menu_uri: '\/mat\/order', menu_form_nm: null, component_nm: null, icon: null, parent_id: 60, sortby: 1, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 62, menu_type_id: 2, menu_nm: '발주 등록', menu_uri: '\/mat\/orders', menu_form_nm: 'frm_MAT_Order', component_nm: 'PgMatOrder', icon: null, parent_id: 61, sortby: 1, use_fg: true, created_uid: 1, updated_uid: 1 },
		...
		{ menu_id: 64, menu_type_id: null, menu_nm: '입하 정보', menu_uri: '\/mat\/receive', menu_form_nm: null, component_nm: null, icon: null, parent_id: 60, sortby: 2, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 65, menu_type_id: 2, menu_nm: '입하 등록', menu_uri: '\/mat\/receives', menu_form_nm: 'frm_MAT_Receive', component_nm: 'PgMatReceive', icon: null, parent_id: 64, sortby: 1, use_fg: true, created_uid: 1, updated_uid: 1 },
		...
		{ menu_id: 67, menu_type_id: null, menu_nm: '반출 정보', menu_uri: '\/mat\/return', menu_form_nm: null, component_nm: null, icon: null, parent_id: 60, sortby: 3, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 68, menu_type_id: 2, menu_nm: '반출 등록', menu_uri: '\/mat\/returns', menu_form_nm: 'frm_MAT_Retrun', component_nm: 'PgMatReturn', icon: null, parent_id: 67, sortby: 1, use_fg: true, created_uid: 1, updated_uid: 1 },
		...
		{ menu_id: 70, menu_type_id: null, menu_nm: '자재출고 정보', menu_uri: '\/mat\/release', menu_form_nm: null, component_nm: null, icon: null, parent_id: 60, sortby: 4, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 71, menu_type_id: 2, menu_nm: '자재출고 등록', menu_uri: '\/mat\/releases', menu_form_nm: 'frm_MAT_Release', component_nm: 'PgMatRelease', icon: null, parent_id: 70, sortby: 1, use_fg: true, created_uid: 1, updated_uid: 1 },
	...
	{ menu_id: 74, menu_type_id: null, menu_nm: '생산관리', menu_uri: 'prd', menu_form_nm: null, component_nm: null, icon: 'ico_nav_production', parent_id: 0, sortby: 4, use_fg: true, created_uid: 1, updated_uid: 1 },
		{ menu_id: 75, menu_type_id: 2, menu_nm: '작업지시등록', menu_uri: '\/prd\/orders', menu_form_nm: 'frm_PRD_Order', component_nm: 'PgPrdOrder', icon: null, parent_id: 74, sortby: 1, use_fg: true, created_uid: 1, updated_uid: 1 },
		{ menu_id: 76, menu_type_id: 2, menu_nm: '자재출고요청 등록', menu_uri: '\/prd\/demands', menu_form_nm: 'frm_PRD_Demand', component_nm: 'PgPrdDemand', icon: null, parent_id: 74, sortby: 2, use_fg: true, created_uid: 1, updated_uid: 1 },
		{ menu_id: 77, menu_type_id: null, menu_nm: '작업실적 정보', menu_uri: '\/prd\/work', menu_form_nm: null, component_nm: null, icon: null, parent_id: 74, sortby: 3, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 78, menu_type_id: 2, menu_nm: '작업실적등록', menu_uri: '\/prd\/works', menu_form_nm: 'frm_PRD_Work', component_nm: 'PgPrdWork', icon: null, parent_id: 77, sortby: 1, use_fg: true, created_uid: 1, updated_uid: 1 },
		...
		{ menu_id: 82, menu_type_id: null, menu_nm: '자재반납 정보', menu_uri: '\/prd\/return', menu_form_nm: null, component_nm: null, icon: null, parent_id: 74, sortby: 4, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 83, menu_type_id: 2, menu_nm: '자재반납 등록', menu_uri: '\/prd\/returns', menu_form_nm: 'frm_PRD_Return', component_nm: 'PgPrdReturn', icon: null, parent_id: 82, sortby: 1, use_fg: true, created_uid: 1, updated_uid: 1 },
	...
	{ menu_id: 85, menu_type_id: null, menu_nm: '영업\/제품관리', menu_uri: 'sal', menu_form_nm: null, component_nm: null, icon: 'ico_nav_sales', parent_id: 0, sortby: 5, use_fg: true, created_uid: 1, updated_uid: 1 },
		{ menu_id: 86, menu_type_id: null, menu_nm: '수주 정보', menu_uri: '\/sal\/order', menu_form_nm: null, component_nm: null, icon: null, parent_id: 85, sortby: 1, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 87, menu_type_id: 2, menu_nm: '수주 등록', menu_uri: '\/sal\/orders', menu_form_nm: 'frm_SAL_Order', component_nm: 'PgSalOrder', icon: null, parent_id: 86, sortby: 1, use_fg: true, created_uid: 1, updated_uid: 1},
		...
		{ menu_id: 89, menu_type_id: null, menu_nm: '제품출하 정보', menu_uri: '\/sal\/outgo', menu_form_nm: null, component_nm: null, icon: null, parent_id: 85, sortby: 2, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 90, menu_type_id: 2, menu_nm: '제품출하지시 등록', menu_uri: '\/sal\/outgo-orders', menu_form_nm: 'frm_SAL_OutgoOrder', component_nm: 'PgSalOutgoOrder', icon: null, parent_id: 89, sortby: 1, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 91, menu_type_id: 2, menu_nm: '제품출하 등록', menu_uri: '\/sal\/outgos', menu_form_nm: 'frm_SAL_Outgo', component_nm: 'PgSalOutgo', icon: null, parent_id: 89, sortby: 2, use_fg: true, created_uid: 1, updated_uid: 1 },
		...
		{ menu_id: 94, menu_type_id: null, menu_nm: '제품입고 정보', menu_uri: '\/sal\/income', menu_form_nm: null, component_nm: null, icon: null, parent_id: 85, sortby: 3, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 95, menu_type_id: 2, menu_nm: '제품입고 등록', menu_uri: '\/sal\/incomes', menu_form_nm: 'frm_SAL_Income', component_nm: 'PgSalIncome', icon: null, parent_id: 94, sortby: 1, use_fg: true, created_uid: 1, updated_uid: 1 },
		...
		{ menu_id: 97, menu_type_id: null, menu_nm: '제품출고 정보', menu_uri: '\/sal\/release', menu_form_nm: null, component_nm: null, icon: null, parent_id: 85, sortby: 4, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 98, menu_type_id: 2, menu_nm: '제품출고 등록', menu_uri: '\/sal\/releases', menu_form_nm: 'frm_SAL_Release', component_nm: 'PgSalRelease', icon: null, parent_id: 97, sortby: 1, use_fg: true, created_uid: 1, updated_uid: 1 },
		...
		{ menu_id: 100, menu_type_id: null, menu_nm: '제품반입 정보', menu_uri: '\/sal\/return', menu_form_nm: null, component_nm: null, icon: null, parent_id: 85, sortby: 5, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 101, menu_type_id: 2, menu_nm: '제품반입 등록', menu_uri: '\/sal\/returns', menu_form_nm: 'frm_SAL_Return', component_nm: 'PgSalReturn', icon: null, parent_id: 100, sortby: 1, use_fg: true, created_uid: 1, updated_uid: 1 },
	...
	{ menu_id: 104, menu_type_id: null, menu_nm: '외주관리', menu_uri: 'out', menu_form_nm: null, component_nm: null, icon: 'ico_nav_outsourcing', parent_id: 0, sortby: 6, use_fg: true, created_uid: 1, updated_uid: 1 },
		{ menu_id: 105, menu_type_id: null, menu_nm: '외주출고 정보', menu_uri: '\/out\/release', menu_form_nm: null, component_nm: null, icon: null, parent_id: 104, sortby: 1, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 106, menu_type_id: 2, menu_nm: '외주출고 등록', menu_uri: '\/out\/releases', menu_form_nm: 'frm_OUT_Release', component_nm: 'PgOutRelease', icon: null, parent_id: 105, sortby: 1, use_fg: true, created_uid: 1, updated_uid: 1 },
		...
		{ menu_id: 108, menu_type_id: null, menu_nm: '외주입하 정보', menu_uri: '\/out\/receive', menu_form_nm: null, component_nm: null, icon: null, parent_id: 104, sortby: 2, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 109, menu_type_id: 2, menu_nm: '외주입하 등록', menu_uri: '\/out\/receives', menu_form_nm: 'frm_OUT_Receive', component_nm: 'PgOutReceive', icon: null, parent_id: 108, sortby: 1, use_fg: true, created_uid: 1, updated_uid: 1 },
	...
	{ menu_id: 111, menu_type_id: null, menu_nm: '품질관리', menu_uri: 'qms', menu_form_nm: null, component_nm: null, icon: 'ico_nav_qualityManagementSystems', parent_id: 0, sortby: 7, use_fg: true, created_uid: 1, updated_uid: 1 },
		...
		{ menu_id: 119, menu_type_id: null, menu_nm: '최종검사 정보', menu_uri: '\/qms\/final-insp', menu_form_nm: null, component_nm: null, icon: null, parent_id: 111, sortby: 4, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 120, menu_type_id: 2, menu_nm: '최종검사 성적서 등록', menu_uri: '\/qms\/final-insp-results', menu_form_nm: 'frm_QMS_FinalInspResult', component_nm: 'PgQmsFinalInspResult', icon: null, parent_id: 119, sortby: 1, use_fg: true, created_uid: 1, updated_uid: 1 },
		...
		{ menu_id: 122, menu_type_id: null, menu_nm: '부적합품 판정 정보', menu_uri: '\/qms\/rework', menu_form_nm: null, component_nm: null, icon: null, parent_id: 111, sortby: 5, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 123, menu_type_id: 2, menu_nm: '부적합품 판정 등록', menu_uri: '\/qms\/reworks', menu_form_nm: 'frm_QMS_Rework', component_nm: 'PgQmsRework', icon: null, parent_id: 122, sortby: 1, use_fg: true, created_uid: 1, updated_uid: 1 },
	...
	{ menu_id: 125, menu_type_id: null, menu_nm: '재고관리', menu_uri: 'inv', menu_form_nm: null, component_nm: null, icon: 'ico_nav_inventory', parent_id: 0, sortby: 8, use_fg: true, created_uid: 1, updated_uid: 1 },
		...
		{ menu_id: 127, menu_type_id: null, menu_nm: '재고실사 정보', menu_uri: '\/inv\/store', menu_form_nm: null, component_nm: null, icon: null, parent_id: 125, sortby: 2, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 128, menu_type_id: 2, menu_nm: '재고실사 등록', menu_uri: '\/inv\/stores', menu_form_nm: 'frm_INV_Store', component_nm: 'PgInvStore', icon: null, parent_id: 127, sortby: 1, use_fg: true, created_uid: 1, updated_uid: 1 },
		...
		{ menu_id: 130, menu_type_id: null, menu_nm: '창고이동 정보', menu_uri: '\/inv\/move', menu_form_nm: null, component_nm: null, icon: null, parent_id: 125, sortby: 3, use_fg: true, created_uid: 1, updated_uid: 1 },
			{ menu_id: 131, menu_type_id: 2, menu_nm: '창고이동 등록', menu_uri: '\/inv\/moves', menu_form_nm: 'frm_INV_Move', component_nm: 'PgInvMove', icon: null, parent_id: 130, sortby: 1, use_fg: true, created_uid: 1, updated_uid: 1 },
		...
		{ menu_id: 137, menu_type_id: 2, menu_nm: '재고 부적합 등록', menu_uri: '\/inv\/stock-rejects', menu_form_nm: 'frm_INV_StockReject', component_nm: 'PgInvStockReject', icon: null, parent_id: 125, sortby: 5, use_fg: true, created_uid: 1, updated_uid: 1 },
	...
	{ menu_id: 138, menu_type_id: null, menu_nm: '금형관리', menu_uri: 'mld', menu_form_nm: null, component_nm: null, icon: 'ico_nav_mold', parent_id: 0, sortby: 9, use_fg: true, created_uid: 1, updated_uid: 1 },
		{ menu_id: 139, menu_type_id: 2, menu_nm: '금형 등록', menu_uri: '\/mld\/mold', menu_form_nm: null, component_nm: 'PgMldMold', icon: null, parent_id: 138, sortby: 1, use_fg: true, created_uid: 1, updated_uid: 1 },
		{ menu_id: 140, menu_type_id: 2, menu_nm: '금형 문제점 등록', menu_uri: '\/mld\/problem', menu_form_nm: null, component_nm: 'PgMldProblem', icon: null, parent_id: 138, sortby: 2, use_fg: true, created_uid: 1, updated_uid: 1 },
		{ menu_id: 141, menu_type_id: 2, menu_nm: '금형 수리 등록', menu_uri: '\/mld\/repair', menu_form_nm: null, component_nm: 'PgMldRepairHistory', icon: null, parent_id: 138, sortby: 3, use_fg: true, created_uid: 1, updated_uid: 1 },
		{ menu_id: 142, menu_type_id: 2, menu_nm: '금형 품목 등록', menu_uri: '\/mld\/mold-prod', menu_form_nm: null, component_nm: 'PgMldProdMold', icon: null, parent_id: 138, sortby: 4, use_fg: true, created_uid: 1, updated_uid: 1 },
