...
const seedDatas: IPrdWorkWorker[] = [
  {
		...
		"work_id" : 1,
		"worker_id" : 1,
		"start_date" : moment("2021-10-25T00:00:00.000Z").toDate(),
		"end_date" : moment("2021-10-25T01:00:00.000Z").toDate(),
		"work_time" : 60.000000,
		"created_uid" : 1,
		"updated_uid" : 1,
	...
	},
	{
		...
		"work_id" : 21,
		"worker_id" : 1,
		"start_date" : moment("2021-02-02T11:20:00.000Z").toDate(),
		"end_date" : moment("2021-03-02T17:30:00.000Z").toDate(),
...
const baseMigration = new BaseMigration('PrdWorkWorker', 'work_worker_id', process.env.DB_RESET_TYPE === 'test' ? seedDatas : []);
